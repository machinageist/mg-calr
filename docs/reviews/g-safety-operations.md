...
**Spec file:** docs/specs/g-safety-operations.md
**Reviewer agent:** Verification agent G, blind review
**Date:** 2026-08-30
...
1. **Renumber the migration.** Replace every reference to
   ...
   suite level; do not resolve it independently inside this spec. Version 6
